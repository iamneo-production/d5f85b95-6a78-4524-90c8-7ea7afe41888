...
export class ProducteditService {
  ...
  constructor(private http: HttpClient) {
    this.apiUrl = 'https://8080-aceefbccfdaedefaacbdafcbadadef.examlyiopb.examly.io/admin/productEdit/';
  ...
  setid(data:any){
    this.productId = data;
    this.apiUrl = 'https://8080-aceefbccfdaedefaacbdafcbadadef.examlyiopb.examly.io/admin/productEdit/'+this.productId;
  }
