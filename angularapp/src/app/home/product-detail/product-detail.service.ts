...
export class ProductDetailService {
  ...
  constructor(private http: HttpClient) {
    this.apiUrl = 'https://8080-aceefbccfdaedefaacbdafcbadadef.examlyiopb.examly.io/home/'; 
  }

  setid(data:any){
    this.productId = data;
    this.apiUrl = 'https://8080-aceefbccfdaedefaacbdafcbadadef.examlyiopb.examly.io/home/'+this.productId;
  }
  ...
  placeOrder(order:Ordermodel):Observable<String>{
    this.apiUrl = 'https://8080-aceefbccfdaedefaacbdafcbadadef.examlyiopb.examly.io/placeOrder';
